...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/HaitaoJin/syzero-core" }]
  },
  locales: {
    root: {
      label: "简体中文",
      ...
      themeConfig: {
        ...
        sidebar: {
          ...
          "/modules/": [
            {
              text: "模块目录",
              items: [{ text: "模块总览", link: "/modules/index" }, ...moduleLinks]
            }
          ]
        },
          ...
          "/en/modules/": [
            {
              ...
              items: [
                ...
                ...moduleLinks.map((m) => ({ text: m.text, link: `/en${m.link}` }))
              ]
            }
          ]
        },
